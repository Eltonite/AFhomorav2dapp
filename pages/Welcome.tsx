function Welcome() {
  return (
    <div className="flex flex-col h-screen justify-center lg:mx-80">
      ...
      <button className="text-gray-300 border-gray-300 hover:text-black hover:border-black hover:bg-gray-300 rounded-xl border-2 text-center p-2 mx-48">Enter Dapp</button>
    </div>
  )
}
